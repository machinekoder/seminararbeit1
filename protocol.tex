...
\put(-32,-350){
\begin{minipage}{13cm}
\bfseries\huge Simulation eines Klasse-D-Verstärker
\end{minipage}
}
...
\begin{figure}[!ht]
\centering
    \includegraphics[width=260pt]{./picture/OPA350_triangle.png}
...
Sägezahnsignal erzeugt. Dieses Signal liegt anschließend an der PWM-Schaltung an.
\subsection{Schaltungsaufbau}
    \begin{figure}[ht]
    \centering
        \includegraphics[width=300pt]{./picture/dreiecksgenerator.png}
        % LM324_triangle.png: 0x0 pixel, 250dpi, 0.00x0.00 cm, bb=
        \caption{Dreiecksgenerator}
    \end{figure}
...
\subsection{Schaltungsaufbau}
    ...
    \centering
        ...
        % LM324_triangle.png: 0x0 pixel, 250dpi, 0.00x0.00 cm, bb=
        \caption{PWM Erzeugung durch Komparator}
    \end{figure}
\subsection{Funktionsweise}
Eingangssignal und Dreiecksignal werden verglichen, am Ausgang entsteht ein PWM Signal, mit konstanter Frequenz und
unterschiedlicher Pulsweite.
% \newpage
...
\subsection{Dimensionierung}
    ...
    \centering
        ...
        % LM324_triangle.png: 0x0 pixel, 250dpi, 0.00x0.00 cm, bb=
        \caption{Treiberschaltung laut LT1160 Datenblatt}
    \end{figure}
\subsection{Funktionsweise}
Das PWM-Signal wird mittels des FET-Treibers LT1160 auf die FETs geschallten, die Treiberstufe wird benötigt um einen
Kurzschluss zu verhindern(immer nur ein FET Aktiv).
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=250pt]{./picture/input_output.png}
        \caption{\label{lc}{Eingangssignal-Ausgangsignal}}
    \end{figure}
\section{Interpretation der Simulation}
Das Ausgang Signal entspricht nicht exakt dem Eingangssignal. Verbesserungen konnte man durch Änderung der
Dimensionierung des Ausgangsfilters erreichen.
